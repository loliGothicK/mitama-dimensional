...
{
    REQUIRE( IS_INVALID_EXPR( accepts_for<sym::L<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( accepts_for<sym::M<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( accepts_for<sym::I<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( accepts_for<sym::S<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( accepts_for<sym::N<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( accepts_for<sym::J<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
