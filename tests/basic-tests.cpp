...
TEMPLATE_TEST_CASE("refinement T^1 negative",
                   ...
                   meter_t, ampere_t, candela_t, kelvin_t, kilogram_t, mol_t)
{
    REQUIRE( IS_INVALID_EXPR( refined_for<sym::T<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( refined_for<sym::L<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( refined_for<sym::M<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( refined_for<sym::I<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( refined_for<sym::S<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( refined_for<sym::N<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
...
{
    REQUIRE( IS_INVALID_EXPR( refined_for<sym::J<1>> |= quantity<DECLTYPE(0)>{} )(TestType) );
}
