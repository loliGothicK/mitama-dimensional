...
// base unit
using meter_t = typename meter_base_unit::unit_type_with_system<::mitama::systems::si::system>;
using metre_t = typename metre_base_unit::unit_type_with_system<::mitama::systems::si::system>;
