...
template < class... TypeIndexedScales >
struct scale_storage_t {};
...
struct lexical_<SP, scale_storage_t<Head, Tail...>, scale_storage_t<Remainders...>>
    : std::conditional_t<std::is_same_v<typename SP::dimension_type, typename Head::dimension_type>,
        lexical_<SP, scale_storage_t<>, scale_storage_t<Remainders..., Tail...>, typename rescaled_<SP, Head>::type>, 
        lexical_<SP, scale_storage_t<Tail...>, scale_storage_t<Remainders..., Head>>
    >
{};

template < class SP, class Inter, class... Tail, class... Remainders >
struct lexical_<SP, scale_storage_t<Tail...>, scale_storage_t<Remainders...>, Inter>
{
...
struct lexical_impl<scale_storage_t<Head, Tail...>, scale_storage_t<R...>, scale_storage_t<Results...>>
    : lexical_impl<
        scale_storage_t<Tail...>,
        typename lexical_< Head, scale_storage_t<R...>, scale_storage_t<>>::remainder,
        mitamagic::tlist_cat_t<scale_storage_t<Results...>, typename lexical_< Head, scale_storage_t<R...>, scale_storage_t<>>::result>
    >
{
};

template < class... R, class... Results >
struct lexical_impl<scale_storage_t<>, scale_storage_t<R...>, scale_storage_t<Results...>>
...
{
    using type
        = typename lexical_impl<
            scale_storage_t<ISSF1...>,
...
using make_dimensional_t = dimensional_t<scale_storage_t<indexed_scale_t<typename Units::dimension_type, typename Units::scale>...>, Units...>;

template < class > struct is_dimensional: std::false_type{};
template < class S, class... Units > struct is_dimensional<dimensional_t<S, Units...>>: std::true_type{};
